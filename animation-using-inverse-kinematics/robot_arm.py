...
class RobArm:
    ...
    def __init__(self, x, y, p):
        ...
        self.y = y
        self.phi = p
        self.t01, self.t02, self.t03, self.t04, self.e = km.fk([[p],[0],[90],[0]], [x, y, 105], 51.5, 246, [-235,0,32.5])
        self.fix_e()
        ...
        self.f1 = Assembly((f1_turn,f1_tb, f1_rec, f1_h1, f1_h2, f1_cov, f1_cov2, f1_mot)).apply_transform(self.t01)
        ...
        self.f2 = Assembly((f2_base,f2_arm, f2_clasp, f2_h1, f2_h2, f2_cov, f2_cov2, f2_con, f2_lid)).apply_transform(self.t02)
        ...
        self.f3 = Assembly((f3_base1, f3_base2, f3_arm, f3_ac, f3_joint,f3_con)).apply_transform(self.t03)
        ...
        self.f4 = Assembly((f4_box,f4_clasp, f4_white, f4_tw, f4_cov1, f4_cov2, f4_cc, f4_cc2, f4_act)).apply_transform(self.t04)
    ...
    def reg_e(self):
        return [self.e[0][0],self.e[1][0],self.e[2][0]]

    def move(self, p):
        self.t01, self.t02, self.t03, self.t04, self.e = km.fk([[self.phi+p[0]], [p[1]],[p[2]],[0]], [self.x, self.y, 105], 51.5, 246, [-235,0,32.5])
        self.fix_e()
