...
def fk(phi, L1, L2, L3, L4):
 ...
 # Matrix of Frame 1 (written w.r.t. Frame 0, which is the previous frame) 
    R_01 = RotationMatrix(phi[0][0], axis_name = 'z')   # Rotation matrix
    ...
    R_12 = RotationMatrix(phi[1][0], axis_name = 'y')   # Rotation matrix
    ...
    R_23 = RotationMatrix(phi[2][0], axis_name = 'y')   # Rotation matrix
    ...
    R_34 = RotationMatrix(0, axis_name = 'x')   # Rotation matrix
